...
--
-- Host: 127.0.0.1
-- Generation Time: 06-Abr-2018 às 14:55
...
--
-- Estrutura da tabela `desfiliacao`
--

CREATE TABLE `desfiliacao` (
  `desf_id` int(11) NOT NULL,
  `desf_sindicato` varchar(20) NOT NULL,
  `desf_sindicato_email` varchar(20) NOT NULL,
  `desf_cnpj` varchar(18) NOT NULL,
  `desf_razao_social` varchar(45) DEFAULT NULL,
  `desf_email` varchar(45) DEFAULT NULL,
  `desf_celular` varchar(15) DEFAULT NULL,
  `desf_core` varchar(45) DEFAULT NULL,
  `desf_segmentos` varchar(150) DEFAULT NULL,
  `desf_data` date DEFAULT NULL,
  `desf_data_envio` date DEFAULT NULL,
  `desf_uf` varchar(2) DEFAULT NULL,
  `desf_cidade_ibge` int(11) DEFAULT NULL,
  `desf_cidade` varchar(20) DEFAULT NULL
...
--
-- Indexes for table `desfiliacao`
--
ALTER TABLE `desfiliacao`
  ADD PRIMARY KEY (`desf_id`);
...
--
-- AUTO_INCREMENT for table `desfiliacao`
--
ALTER TABLE `desfiliacao`
  MODIFY `desf_id` int(11) NOT NULL AUTO_INCREMENT;
